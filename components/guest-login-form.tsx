...
export function GuestLoginForm() {
  ...
  return (
    <form onSubmit={submit} className="mx-auto max-w-sm space-y-4 rounded-lg border border-slate-200 bg-white p-6 shadow-table">
      <div>
        <h2 className="text-xl font-semibold text-slate-950">查看排班</h2>
        <p className="mt-1 text-sm text-slate-600">请输入科室管理员提供的查看密码。</p>
      </div>
      <label className="block">
        <span className="text-sm font-medium text-slate-700">查看密码</span>
